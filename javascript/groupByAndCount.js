...
function groupByAndCount(items, keyClassifier) {
    const groupedObjects = {};
    ...
    for(let key in groupedObjects) {
        groupedObjects[key] = groupedObjects[key].length;
    }
...
const objectsCountedByPriceRange = groupByAndCount(products, priceClassifier);
console.table(objectsCountedByPriceRange);
